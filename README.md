...
через сервера почты, даже при белых списках. <br> <br>
...
Это гарантирует, что:
1. Код проекта всегда доступен для независимого аудита безопасности.
2. Любые модификации или форки этого приложения также обязаны оставаться открытыми и бесплатными.
